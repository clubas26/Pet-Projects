...
top10_stocks = top10.index
undervaluation_scores = top10['Undervaluation Score']

# Create a bar chart
plt.figure(figsize=(10, 6))
plt.bar(top10_stocks, undervaluation_scores, color='skyblue')

# Add labels and titles
plt.title('Top 10 Most Undervalued S&P 500 Stocks')
plt.xlabel('Stock Symbol')
plt.ylabel('Undervaluation Score')
